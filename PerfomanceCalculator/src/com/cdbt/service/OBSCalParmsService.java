...
public class OBSCalParmsService {
	public String[] getOBSResult(String num, String rwyEndAlt, String oBSAlt, String lineLength, String turnLength,
		...
		double height = CommonUtils.strToDouble(oBSAlt) - CommonUtils.strToDouble(rwyEndAlt);
		double corrHeight = height + tree
				+ CommonUtils.strToDouble(turnLength) * CommonUtils.strToDouble(gradLoss) / 100.0D;
		double totalLength = CommonUtils.strToDouble(lineLength) + CommonUtils.strToDouble(turnLength);
		...
		String[] result = { String.valueOf(num), oBSAlt,
				CommonUtils.doubleToStr(Double.valueOf(height), Integer.valueOf(1)),
